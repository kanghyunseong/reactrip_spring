...
public class AdminCommentController {
	...
	public ResponseEntity<ResponseData<AdminCommentDTO>> deleteStatus(
			@PathVariable(name = "commentNo") Long commentNo,
			@RequestBody AdminCommentDTO dto) {
		
		AdminCommentDTO status = adminCommentService.deleteStatus(commentNo, dto);
